...
<!-- chart libraries start -->
<script src="<%= path%>/admin/bower_components/flot/excanvas.min.js"></script>
<script src="<%= path%>/admin/bower_components/flot/jquery.flot.js"></script>
<script src="<%= path%>/admin/bower_components/flot/jquery.flot.pie.js"></script>
<script src="<%= path%>/admin/bower_components/flot/jquery.flot.stack.js"></script>
<script src="<%= path%>/admin/bower_components/flot/jquery.flot.resize.js"></script>
<!-- chart libraries end -->
<script src="<%= path%>/admin/js/init-chart.js"></script>
