	        ...
	        <div class="box-inner">
	            ...
	            <div class="box-content">
	                <ul class="ajax-loaders">
	                                            <li><img src="<%= path%>/admin/img/ajax-loaders/ajax-loader-1.gif"
	                                 title="<%= path%>/admin/img/ajax-loaders/ajax-loader-1.gif"></li>
	                                            <li><img src="<%= path%>/admin/img/ajax-loaders/ajax-loader-2.gif"
	                                 title="<%= path%>/admin/img/ajax-loaders/ajax-loader-2.gif"></li>
	                                            <li><img src="<%= path%>/admin/img/ajax-loaders/ajax-loader-3.gif"
	                                 title="<%= path%>/admin/img/ajax-loaders/ajax-loader-3.gif"></li>
	                                            <li><img src="<%= path%>/admin/img/ajax-loaders/ajax-loader-4.gif"
	                                 title="<%= path%>/admin/img/ajax-loaders/ajax-loader-4.gif"></li>
	                                            <li><img src="<%= path%>/admin/img/ajax-loaders/ajax-loader-5.gif"
	                                 title="<%= path%>/admin/img/ajax-loaders/ajax-loader-5.gif"></li>
	                                            <li><img src="<%= path%>/admin/img/ajax-loaders/ajax-loader-6.gif"
	                                 title="<%= path%>/admin/img/ajax-loaders/ajax-loader-6.gif"></li>
	                                            <li><img src="<%= path%>/admin/img/ajax-loaders/ajax-loader-7.gif"
	                                 title="<%= path%>/admin/img/ajax-loaders/ajax-loader-7.gif"></li>
	                                            <li><img src="<%= path%>/admin/img/ajax-loaders/ajax-loader-8.gif"
	                                 title="<%= path%>/admin/img/ajax-loaders/ajax-loader-8.gif"></li>
	                                    </ul>
